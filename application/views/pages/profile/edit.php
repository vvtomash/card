...
<? if ($profile->checkFullness()) { ?>
	<div class="alert alert-warning" role="alert">
		<stong>Внимание! </stong>При сохранении неполного профайла ваши объявления о покупке будут заблокированы
	</div>
<? } else { ?>
	<div class="alert alert-warning" role="alert">
		Для совершения покупок необходимо заполнить профайл
	</div>
<? } ?>
<form class="form-profile" method="post" action="/profile/update">
	...
	<p class="text-muted">
		<small class="text-muted">* Эти поля необходимо заполнить для совершения покупок.</small>
	</p>
</form>